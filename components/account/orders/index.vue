<template>
  ...
  <div class="order-status">
    <div @click="active = !active" class="row row_al-c row_gap4 pointer">
    ...
    >
      ...
      <div class="column column_gap12">
        <div class="tip tip_dark-fill tip_small">
          {{ data.statuses[4].title }}
        </div>
  ...
  <div v-else>
    ...
    <div v-else class="text text_normal text_accent empty-list">
  ...
  <OverflowContainer
    ...
    @closeOverflow="closeProfilePopup()"
  >
    <OverflowNotValidProfile
...
const emits = defineEmits(["navigateToProfile", "toAuth"]);

const isProfilePopupActive = ref(false);
...
function toProfile() {
  emits("navigateToProfile");
}

function closeProfilePopup() {
  isProfilePopupActive.value = false;
}
</script>
