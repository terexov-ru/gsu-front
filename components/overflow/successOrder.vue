  ...
  <Overflow class="order-overflow">
    ...
    <div class="overflow__content">
      <svg width="108" height="108" viewBox="0 0 108 108" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <defs>
          <filter id="filter0_d_3167_35844" x="0.25" y="0.25" width="107.5" height="107.5" filterUnits="userSpaceOnUse"
      ...
      <div class="column column_gap16">
        ...
        <div class="text text_normal text_center">Информация о заказке выслана вам на почту <b>{{ mail }}</b>. Наш
          менеджер свяжется с вами в ближайшее время для уточнения данных.
        </div>
      </div>
